...
$html .= "<table id='tablaSeleccionEmpleadosModificar' cellpadding='10' cellspacing='1'  class='tabla' style='width: 100%;'>";
$html .= "<thead>";
...
{
	$html .= "<tr onclick='seleccionarEmpleadoModificar(".$pos->id.")' style='cursor:pointer'>";
