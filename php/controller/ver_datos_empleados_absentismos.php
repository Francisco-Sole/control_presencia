...
{
	$pos->foto = base64_encode($pos->foto);
	$html .= "<tr onclick='seleccionarEmpleadoVerAbsentismo(". json_encode($pos).")' style='cursor:pointer'>";
	...
	if (empty($pos->foto)) {
		...
		$html .= "<td><img src='data:image/png;base64,".($pos->foto)."' height=60px/></td>";		
	}
